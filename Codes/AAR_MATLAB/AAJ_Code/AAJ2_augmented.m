function [x, iter, reshist, SOL_HIST] = AAJ2_augmented(A,b,x_guess,tol,max_iter,M1,M2,omega,beta,m,p)
...
clear AndersonMixing_AAJ_augmented
relres = tol+1;
count = 1;
...
%     fprintf('Iteration: %d, Residual= %g \n',count,relres)
    x = x_new;    
    [x_new] = AndersonMixing_AAJ_augmented(x_prev,  x_new-x_prev,  m,  count,  beta, p); 
    x_prev = x_new;
    count = count + 1;
end
clear AndersonMixing_AAJ_augmented
