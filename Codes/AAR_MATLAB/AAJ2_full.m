function [x, iter, reshist, SOL_HIST] = AAJ2_full(A,b,x_guess,tol,max_iter,M1,M2,beta)
...
while count<=max_iter && relres > tol
    ...
    x = x_new;    
    x_new = AndersonMixing_AAJ_full(x_prev,  x_new-x_prev,  count,  beta);   
    x_prev = x_new;
    count = count + 1;
end
clear AndersonMixing_AAJ_full
