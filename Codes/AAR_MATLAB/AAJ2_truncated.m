function [x, iter, reshist, SOL_HIST] = AAJ2_truncated(A,b,x_guess,tol,max_iter,M1,M2,beta,trunc)
...
clear AndersonMixing_AAJ_truncated
relres = tol+1;
count = 1;
while count<=max_iter && relres > tol
    ...
    x = x_new;    
    x_new = AndersonMixing_AAJ_truncated(x_prev,  x_new-x_prev,  count,  beta, trunc);   
    x_prev = x_new;
    count = count + 1;
end
clear AndersonMixing_AAJ_truncated
