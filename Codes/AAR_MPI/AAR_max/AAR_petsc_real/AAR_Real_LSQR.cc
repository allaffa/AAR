...
int main( int argc, char **argv )
{
  ...
  ierr = PetscOptionsSetValue(PETSC_NULL, "-pc_hypre_pilut_tol","0.05"); CHKERRQ(ierr);
  ierr = PetscOptionsSetValue(PETSC_NULL, "-pc_hypre_parasails_nlevels","1"); CHKERRQ(ierr);
  ierr = PetscOptionsSetValue(PETSC_NULL, "-pc_hypre_parasails_thresh","0.05"); CHKERRQ(ierr);
  ...
  AARSetUp(&aar_solver, &A, &x_guess, &prec, 6, aar_parameters.p_aar, aar_parameters.omega, aar_parameters.maxit, aar_parameters.solver_tol);
...
static PetscErrorCode PCSetFromOptions_HYPRE_Parasails()
{
   ...
   ierr = PetscOptionsSetValue(NULL, "-pc_hypre_parasails_nlevels","5"); CHKERRQ(ierr);
   ierr = PetscOptionsSetValue(NULL, "-pc_hypre_parasails_thresh","0.01"); CHKERRQ(ierr);
   //PetscOptionsEnd();
