...
exec='../ex1'
testname='runex1'
label='sys_classes_gll_tutorials-ex1_1'
runfiles=''
...
if test $res = 0; then
   petsc_testrun "${diff_exe} /sunhome/mlupopa/priv/PhD_project/Codes/Linear_Solver/AAR_MPI/petsc-3.8.0/src/sys/classes/gll/examples/tutorials/output/ex1_1.out ex1_1.tmp" diff-${testname}.out diff-${testname}.out diff-${label} ""
else
